...
public class WaveSpawnerBosses : MonoBehaviour
{
    [SerializeField] private GameObject[] enemy;
    [SerializeField] private int maxSumEnemy = 5;
    ...
    [SerializeField] private int LifeIncreaseBosses = 50;
    ...
    public void Update()
    {
        if (gameManager.Health != 0)
        {
            ...
            int randomAmountEnemy = Random.Range(1, maxSumEnemy);
            ...
            if (enemiesSpawned == randomAmountEnemy)
            {
                ...
                gameManager.HealthEnemyBosses += LifeIncreaseBosses;
                gameManager.Wave++;
